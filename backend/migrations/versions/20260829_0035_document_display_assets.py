...
# The integration branch already merged the medication-catalog and profile
# migrations into 20260830_0035. Continue from that combined head so this
# PR does not create a second Alembic head.
