...
_REGISTRY = {
    (DEMO_FILE_HASHES["lab_report"], "lab_report", FALLBACK_DATA_VERSION): _payload(
        {
            "hospital_name": "POMI SYNTHETIC CLINIC 01",
        ...
        [
            ("items.0.item_name", "LH"),
            ("items.0.numeric_value", 4.1),
            ("items.0.normalized_unit", "IU/L"),
        ],
    ),
    (DEMO_FILE_HASHES["medical_order"], "medical_order", FALLBACK_DATA_VERSION): _payload(
        {
            ...
            "prescribed_at": "2026-07-01",
            "orders": [
                {
                    "source_text": "METFORMIN-1 500 mg twice daily",
                    "drug_name": "METFORMIN-1",
                    "normalized_drug_name": "METFORMIN-1",
        ...
        [
            ("orders.0.drug_name", "METFORMIN-1"),
            ("orders.0.dosage_value", 500),
            ("orders.0.dosage_unit", "mg"),
            ("orders.0.frequency", "twice daily"),
        ],
    ),
    (
    ...
    ): _payload(
        {
            ...
            "findings_text": "Synthetic finding 1: bilateral ovaries visualized.",
            "conclusion_text": "Synthetic impression 1: no acute finding.",
            "examined_at": "2026-07-01",
